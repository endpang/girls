...
Page({
  ...
  fetchTags() {
      ...
      console.log('url: ' + util.getUrl('/tags.php'));
      return request({ method: 'GET', url: util.getUrl('/tags.php') });
  },
  fetchImgs(cid) {
      console.log("cid",cid)
      this.showLoading('loading...');
      //console.log("empty", util.isEmpty(cid))
      return request({ method: 'GET', url: util.getUrl('/girls.php', [{ c:  cid }, { p: this.data.page }, { m: this.data.mid }]) });
